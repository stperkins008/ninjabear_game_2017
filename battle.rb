...
class Battle
	...
	def fight_narrative
		puts "This is an epic battle for the ages.  #{@fighter1.name} has shown great strength and tenacity.  However, #{@fighter2.name} is even tougher.  Time will tell who will come out victorious."
	end
